				...
				request
					...
					.end(function(err, res){
						...
						newState["processedStatus"] = res.body.status;
		 				...
		 				newState["addedVehicleType"] = undefined;
						newState["addedVdisplayText"] = undefined;
						...
						request.get(url).then((response) => {
							...
							newState2["addedVehicleType"] = undefined;
							newState2["addedVdisplayText"] = undefined;
							...
							x.state.addedVehicleType = undefined;
							x.state.addedVdisplayText = undefined;
					...
					<div className="well">
						...
						<div className="row" onBlur={this.processRecord}>
							<div className="col-md-4">
								<input className="vehicleType" 
									type="text"
									name={"vehicleType_"+(this.state.vehicleTypes.length)}
									defaultValue=""
									onChange={this.vehicleTypeSelect} 
								/>
							</div>
							<div className="col-md-4">
								<input className="vdisplayText" 
									type="text"
									name={"vdisplayText_"+(this.state.vehicleTypes.length)}
									defaultValue=""
									onChange={this.vdisplayTextSelect} 
								/>
							</div>
